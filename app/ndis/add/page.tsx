...
export default function AddNdisProviderPage() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        toast({
          title: "Success",
          description: "NDIS provider created successfully",
        })

        // Redirect back to NDIS page
        router.push("/ndis")
      } else {
        // Handle API error
        ...
        toast({
          title: "Error",
          description: response.message || "Failed to create NDIS provider",
          variant: "destructive",
        })
      }
    } catch (error) {
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-6 pt-6">
      <div className="flex items-center justify-between">
        <Breadcrumb linkHref="/ndis" linkLabel="NDIS Providers" currentPage="Add New Provider" />
        <Button variant="outline" size="sm" onClick={() => router.push("/ndis")} className="gap-2">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Add New NDIS Provider</CardTitle>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex justify-between pt-4 border-t">
                ...
                <div className="flex gap-2">
                  <Button type="button" variant="outline" onClick={() => router.push("/ndis")}>
                    Cancel
                  </Button>
